...
function showTab(n) {
    ...
    if (n == (x.length - 1)) {
        $("#nextBtn").attr('onClick', 'api_idea_add(this);');
...
function validateForm() {
    ...
    //標題
    let idea_title = $("input.idea_input[name='name']");

    //判斷有無標題
    if (currentTab === 0 && idea_title.val() == "") {
        check_data_error('未填寫作品標題')
        idea_title.addClass('invalid');
        valid = false;
    }
     else {
